...
export function Banner() {
    return(
        <div className="z-10 w-full h-2/4 m-0 p-0 bg-cover bg-bottom bg-[url(https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fwallpapercave.com%2Fwp%2Fwp5522079.jpg&f=1&nofb=1&ipt=9aee829ffff8b447fdbc0690a5536759c50ff4366a243aa8714e0098df42b3aa)]">
            <div className="w-full h-full">
                <div className="w-full h-full bg-black/62 z-40 text-white">
                    <h2 className="text-7xl font-extrabold pt-8 p-[5rem]">Stranger Things</h2>
